...
WPSC (WP Static Platform) không phải là một Static Site Generator truyền thống.

Mục tiêu của WPSC là xây dựng một **Workspace Platform** cho phép quản lý nhiều website tĩnh trên cùng một Framework, sử dụng chung hạ tầng, nhưng vẫn đảm bảo mỗi website hoạt động hoàn toàn độc lập.
...
Có lỗi trong quá trình Setup hoặc Build.
...
Wizard sẽ Trigger Build đầu tiên.
...
Không xử lý dữ liệu Source.

---

## 9.7 Queue

Webhook luôn đi qua Queue.
...
# Sprint 6 — Site Initialization & Provisioning
