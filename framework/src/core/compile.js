...
import createJsonFileCache, { createCacheKey } from "../builder/cache/createJsonFileCache.js";
import createRouteRenderCache from "../builder/cache/createRouteRenderCache.js";
import readThroughCache from "../builder/cache/readThroughCache.js";
...
function createRouteLayout(route, context, template) {
  ...
  return ({ context: renderingContext, html }) => {
    const result = renderLayout(template.raw, {
      content: renderingContext.content,
      graph: context.graph,
      html,
      route,
      site: renderingContext.site,
      theme: context.theme
    });
