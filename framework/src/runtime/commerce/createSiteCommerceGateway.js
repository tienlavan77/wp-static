...
import createWooCommerceAccountService from "./createWooCommerceAccountService.js";
import createWordPressAuthService from "./createWordPressAuthService.js";
...
export default function createSiteCommerceGateway(options = {}) {
  ...
  async function runtimeFor(siteId) {
    ...
    const runtime = createCommerceRuntime({
      ...
      checkoutProxy: account.checkoutProxy,
