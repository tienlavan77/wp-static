...
import createSiteRegistry from "../site/createSiteRegistry.js";
import createSiteOperationsService from "../operations/createSiteOperationsService.js";
import createSiteBackupService from "../backup/createSiteBackupService.js";
import createDeploymentArtifactService from "../deployment/createDeploymentArtifactService.js";
import createDeploymentOrchestrationService from "../deployment/createDeploymentOrchestrationService.js";
...
import loadRuntimeEnvironment from "../runtime/bootstrap/loadRuntimeEnvironment.js";
...
async function main(cliArgs) {
  if (cliArgs.includes("--build-example")) {
    await buildProject("fixtures/basic-shop");
    return;
  }
...
async function runProductCommand(cliArgs, workspaceArg) {
