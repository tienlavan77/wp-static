...
export default function createBuildIntegration(options = {}) {
  ...
  async function build(input = {}) {
    ...
    try {
      ...
      const built = await runtimeV1Builder.build({ buildId: started.buildId, changed: input.changed || [], collections: source.collections, contents: source.items, site: { ...site, siteId: started.context.siteId }, siteId: started.context.siteId });
