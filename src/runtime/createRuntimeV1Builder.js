...
import parseChangedItem from "../planner/parseChangedItem.js";
import planIncrementalBuild from "../planner/planIncrementalBuild.js";
...
export default function createRuntimeV1Builder(options = {}) {
  ...
  return Object.freeze({
    async build(input = {}) {
      ...
      const config = createSharedStorefrontBuildConfig({ outputDir, plugins: input.plugins || [], site: input.site || {} });
